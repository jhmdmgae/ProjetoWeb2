            ...
            <body>
                <div class="geral">
                    ...
                    <div class="conteudo">
                        ...
                        <form action='funccontroller.do?acao=AlterarFuncionario&id=${funcionario.id}' method='post' name='formulario'>
                            <fieldset>
                                ...
                                <div class="campo">
                                    ...
                                    <input type='text' id='nome' name='nome' value='' size="${funcionario.nome}"/>
                                </div>
                                <div class="campo">
                                ...
                                <div class="campo">
                                    ...
                                    <input type='text' id='cargo' name='cargo' value='${funcionario.cargo}' size="41"/>
                                </div>
                                ...
                                <div class="campo">
                                    ...
                                    <textarea id="observacao" name="observacao" Style="width: 267px;height: 100px;" >${observasscao}</textarea>
                                </div>
                                <div class="campo">
