            ...
            <body>
                <div class="geral">
                    ...
                    <div class="conteudo">
                        ...
                        <div class="menu2">
                            <a href="apartcontroller.do?acao=forcadastrar">Adicionar Apartamento</a>
                        </div>
                        <div class="div-table">
                            ...
                            <c:forEach items="${aparts.buscarTodos()}" var="apt">
                                <div class="div-table-row">
                                    <div class="div-table-col">
                                        <a href="apartcontroller.do?acao=excluir&id=${apt.id}">Excluir</a>
                                        <a href="apartcontroller.do?acao=foreditar&id=${apt.id}">Editar</a>
                                    </div>
