            ...
            <body>
                <div class="geral">
                    ...
                    <div class="conteudo">
                        ...
                        <div class="menu2">
                            <a href="apartcontroller.do?acao=FormCadastroApartamento">Adicionar Apartamento</a>
                        </div>
                        <div class="div-table">
                            ...
                            <jsp:useBean id="aparts" class="br.com.condominio.jdbc.dao.ApartamentoDAO"/>
                            <c:forEach items="${aparts.buscarTodos()}" var="apt">
                                <div class="div-table-row">
                                    <div class="div-table-col">
                                        <a href="apartcontroller.do?acao=ExcluirApartamento&id=${apt.id}">Excluir</a>
                                        <a href="apartcontroller.do?acao=FormAlterarApartamento&id=${apt.id}">Editar</a>
                                    </div>
